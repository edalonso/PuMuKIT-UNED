  ...
  <div style="float:left;">
    <div>&nbsp;Palabras clave</div>
      <div >
        ...
        <!-- <input type="image" src="/images/uned/lupa_buscador.png" style="position: relative; top: 2px; right: 20px;" name="startsearch" /> -->
        <input type="image" src="/images/uned/lupa_buscador.png" style="position: relative; top: 1px; right: 22px;" name="startsearch" />
      </div>
