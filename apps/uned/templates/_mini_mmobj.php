<div class="unedtv_mini_mmobjs" id="Scroller-<?php echo $num?>">
<div class="Scroller-Container-<?php echo $num?>">
<?php foreach($mmobjs as $mmobj):?>
<dl class="unedtv_mini_mmobj">
  <dt class="thumbnail" style="width: 110px">
    <a href="<?php echo url_for('mmobj/index?id=' . $mmobj->getId())?>" >
      <div style="background-color: #FFF; text-align: center; padding: 4px; box-shadow: 1px solid #000;">
        <div class="border_mmobj" style="background-color: #000; text-align: center; padding: 0px; box-shadow: none;">
             <div class="img" style="max-height: 62px; vertical-align: middle; position: relative;">
                ...
                <img src="<?php echo $mmobj->getFirstUrlPic()?>" style="max-height: 62px; max-width: 102px; vertical-align: middle; text-align: center;"/>
             </div>
        </div>
      </div>
    </a>
  ...
  <dd class="info">
    <div class="title" style="margin-left: 115px;">
      <a title="<?php echo $mmobj->getTitle()?>" href="<?php echo url_for('mmobj/index?id=' . $mmobj->getId())?>" >
        <?php echo str_abbr($mmobj->getTitle(), 50, "...") ?>
      </a>
    </div>
  </dd>
