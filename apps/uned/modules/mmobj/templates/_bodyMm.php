<div>
  ...
  <?php if ($mm->getSerial()->getDisplay()) :?>
    <div style="clear: left;">
       <span style="font-weight: bolder">Serie:</span> <a style="font-size: 0.85em" href="<?php echo $mm->getSerial()->getUrl()?>"><?php echo $mm->getSerial()->getTitle() ?></a>
    </div>
  <?php endif;?>
