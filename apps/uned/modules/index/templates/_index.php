   ...
   <tr>
     <td rowspan="2">
       <div class="img_category">
         ...
         <img alt="Recursos Educativos" src="/images/uned/MEDIATECA_recursos_educativos.jpg" style="height: 350px; width: 220px"/>
     ...
     <?php else :?>-->
         <a href="<?php echo url_for('destacados_TV')?>">
           <img alt="Videos por centros" height="200" width="251" src="/images/uned/MEDIATECA_destacados_TV.jpg" />
     ...
     <td>
       <div class="img_category">
         <a href="<?php echo url_for('destacados_RADIO/index')?>">
           <img alt="Clases y polimedias" height="148" width="251" src="/images/uned/MEDIATECA_destacados_radio.jpg" />
     ...
     <td>
       <div class="img_category">
         <a href="<?php echo url_for('teleactos')?>">
           <img alt="Canal empleo"  height="163" width="241" src="/images/uned/MEDIATECA_teleactos.jpg" />
     ...
     <td>
       <div class="img_category">
         <a href="<?php echo url_for('noticias')?>">
           <img alt="Institucional" height="185" width="241" src="/images/uned/MEDIATECA_noticias.jpg" />
