...
<div class="form-row">
  ...
  <div class="content">
    <textarea id="embed_code" name="embed_code" readonly="readonly" cols="80" rows="5" onclick="this.select()"><iframe src="<?php echo $sf_request->getUriPrefix() ?>/mmobj/iframe/id/<?php echo $file->getMmId() ?>" style="border:0px #FFFFFF none;" scrolling="no" frameborder="1" height="270" width="480" allowfullscreen webkitallowfullscreen></iframe></textarea>
  </div>
</div>
...
<div class="form-row">
  ...
  <div class="content">
    <input type="text" onclick="this.select()" size="80" value="<?php echo $file->getInternalUrl(true) ?>" />
  </div>
  <br />
