...
<form method="post" enctype="multipart/form-data" target="iframeUpload" action="<?php echo url_for('materialevents/upload')?>">
<iframe name="iframeUpload" style="display:none" src=""></iframe>


<?php echo object_input_hidden_tag($material, 'getId') ?>
<input type="hidden" name="event" id="event" value="<?php echo $material->getEventId() ?>" />
