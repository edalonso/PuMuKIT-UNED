<div class="tv_admin_container extractpic">
    <fieldset>
      <div style="width: 525px; height: 390px; float: left;">
         <p class="SimPlayerText" style="color: #000; border-radius: 4px; margin-top: 150px; font-size: 20px;">El archivo seleccionado solo contiene audio.<br /> Puede seleccionar una imagen de su lista local.</p>
      </div>
