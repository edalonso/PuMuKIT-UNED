...
<!--<div class="form-row">
  <?php echo label_for('acceptedmimetype', 'Mime Type válidos:', 'class="required" ') ?>
  <div class="content">
     <?php $value = object_input_tag($profile, 'getAcceptedMimeType', array ('size' => 60,  
								    'control_name' => 'acceptedmimetype')); 
           echo $value ? $value : '&nbsp;' ?>
  </div>
</div>-->
