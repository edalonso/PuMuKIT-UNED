  ...
  <div id="tv_admin_content" >
    ...
    <div style="float:right; width:50%">
      <ul class="tv_admin_actions">
        ...
        <li>
          <?php echo link_to_remote('Crear', array('update' => 'list_mms', 'url' => 'mms/create?filter=filter&page=last', 'script' => 'true'), array('title' => 'Crear nuevo objeto multimedia', 'class' => 'tv_admin_action_create')) ?>
        </li>
      </ul>
    </div>
