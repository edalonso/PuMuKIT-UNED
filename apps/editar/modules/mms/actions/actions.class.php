...
class mmsActions extends sfActions
{
  ...
  public function executeList()
  {
    ...
    if ($this->hasRequestParameter('mm_id')) {
      $this->mm_sel = $this->getRequestParameter('mm_id');
      $this->getUser()->setAttribute('id', $this->mm_sel, 'tv_admin/mm');
...
// --- Actualiza los timeframes - decisiones editoriales temporizadas ---
  ...
  {
    $new = MmPeer::createNew($this->getUser()->getAttribute('serial'));
    $this->mm_sel = $new->getId();
    $this->getUser()->setAttribute('id', $new->getId(), 'tv_admin/mm');
    $this->reloadEditAndPreview = true;
