...
<div id="tv_admin_container">
  <div id="tv_admin_bar">
    <div id="preview_serial" style="min-height:80px; padding:5px; border: solid 1px #DDD; background: #8eb0bc url(/images/admin/cab/cab.gif) repeat-x scroll 0% 0%; margin-bottom: 10px">
      <?php include_component('serials', 'preview') ?>
    </div>
    
    <?php include_partial('acordeon', array('name' => 'serial')) ?> 
  ...
  <div id="tv_admin_content" >
    ...
    <div style="float:right; width:50%">
      <ul class="tv_admin_actions">
        ...
        <li>
         <?php echo link_to_remote('Crear', array('before' => '$("filter_serials").reset();', 'update' => 'list_serials', 'url' => 'serials/create?filter=filter', 'script' => 'true'), array('title' => 'Crear nueva serie', 'class' => 'tv_admin_action_create')) ?>
        </li>
      </ul>
    </div>
