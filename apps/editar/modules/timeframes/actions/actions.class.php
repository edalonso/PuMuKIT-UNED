...
class timeframesActions extends sfActions
{
   ...
   /**
    ...
    /**
     * Destacados_TV - genera editar.php/timeframes/tv_timeline.xml      
     ...
     */
    public function executeTvTimeline()
    {
        sfLoader::loadHelpers(array('Url'));
        $this->incluye_fijas      = $this->getRequestParameter('incluye_fijas', 0);
        $this->incluye_en_proceso = $this->getRequestParameter('incluye_en_proceso', 0);
        $cod_destacados_tv        = CategoryMmTimeframePeer::DESTACADOS_TV;
...
<data>
    ...
    /**
     * Destacados_Radio - genera editar.php/timeframes/radio_timeline.xml      
     *
     * TO DO - limitar inferiormente la lista de timeframes a n meses o cargar dinámicamente
     */
    public function executeRadioTimeline()
    {
        sfLoader::loadHelpers(array('Url'));
        $this->incluye_fijas      = $this->getRequestParameter('incluye_fijas', 0);
        $this->incluye_en_proceso = $this->getRequestParameter('incluye_en_proceso', 0);
        $cod_destacados_radio     = CategoryMmTimeframePeer::DESTACADOS_RADIO;
...
<data>
    ...
    public function executeTvRadioTimeline()
    {
        sfLoader::loadHelpers(array('Url'));
        $this->incluye_fijas      = $this->getRequestParameter('incluye_fijas', 0);
        $this->incluye_en_proceso = $this->getRequestParameter('incluye_en_proceso', 0);
