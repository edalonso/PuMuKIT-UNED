...
function escogeOrigenXml($destacados){
  switch ($destacados){
    case 'tv':
      $ruta_xml = '@tv_timeline';
      break;
    case 'radio':
      $ruta_xml = '@radio_timeline';
      break;
    default:
      $ruta_xml = '@tv_radio_timeline';
      break;
  }
  return $ruta_xml;
} ?>
<h3 class="cab_body_div"><img src="/images/admin/cab/serial_ico.png"/> Línea de tiempo - Destacados Radio / TV</h3>
...
<div id="timeframes-dashboard-cabecera" style="overflow:hidden;">
  ...
  <div id="leyenda" style="float:left;">
      ...
      <div style="color:<?php echo $radio_color?>;width:100px; border-top: 3px solid;">Destacados Radio</div>
      <div style="color:<?php echo $tv_color?>;width:100px; border-top: 3px solid;">Destacados TV</div>
  ...
  <div id="timeframes-dashboard-select" style="float:left; padding:0 0 0 10px;">
     <form id="form-destacados" name="form-destacados" method="get" action="<?php echo url_for('timeframes/indexDash')?>">
      <div id = "select-destacados" style="width:150px; float:left;">
        <div style="font-weight:bold;">&nbsp;Destacados <span style="color:<?php echo $radio_color?>">Radio</span> / <span style="color:<?php echo $tv_color?>">TV</span></div>
