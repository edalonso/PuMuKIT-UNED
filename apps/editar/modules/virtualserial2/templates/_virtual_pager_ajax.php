...
?>
  ...
  <div id="pager_<?php echo $name?>" style="float:left;">
    <div style="float:left; margin:0em .5em;"><?php echo link_to_remote('&laquo;Anterior', array('update' => 'list_'.$name.'s', 'url' => 'virtualserial/list?page='.($page-1), 'script' => 'true'), $ver_anterior)  ?></div>
    ...
    <div style="float:left; margin:0em .5em;"><?php echo link_to_remote('Siguiente&raquo;', array('update'=> 'list_'.$name.'s', 'url' => 'virtualserial/list?page='.($page+1), 'script' => 'true'), $ver_siguiente) ?></div>
  </div>
  ...
  <?php if ( $total>1 ): ?>
    <script language="javascript" type="text/javascript">
      ...
      new Control.Slider("handle_<?php echo $name?>", "track_<?php echo $name?>", {
        ...
        onChange: function(v){new Ajax.Updater("list_<?php echo $name ?>s", "/editar.php/virtualserial/list/page/"+v, {asynchronous:true, evalScripts:true})}
      } );
