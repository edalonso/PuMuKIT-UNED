         <table style="float: left; width: 300px; margin: 15px 0px 0px 180px" class="unedtv_mmobj">
            <tr colspan="3">
               <td width="1%" valign="top"  style="background-color:transparent"> <!-- hack-->
                  ...
                  <div id="serial_mm_pics"> 
                     <?php foreach ($pics as $value): ?>
                        <span class="video-duration"><?php $file = $mm->getFirstFile(); echo $file->getDurationMin()?>:<?php echo $file->getDurationSeg()?></span>
                        <img style="border:1px solid #000000; height:82px; width:100px;" src="<?php echo $value ?>" class="serial" />
                        <?php break; ?>
                     <?php endforeach; ?>
