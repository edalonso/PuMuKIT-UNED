...
<div style="float:left; border: 1px solid rgb(206, 194, 194); padding: 5px; margin: 1% 2% 1% 0%; position: relative;">
  <table>
     <tr>
       ...
       <input type="submit" name="search" value="Buscar" id="enviar" class="btn" style="background: #ddd url(/images/uned/lupa_buscador.png) no-repeat 0% 50%; cursor:pointer; padding: 4px 4px 4px 20px; width: 60px; position:absolute; right: 20px; bottom: 10px;" />
     </tr>
  </table>
