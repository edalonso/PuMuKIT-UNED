<ul style="width: 95%;">
  ...
  <li class="first_node">
   ...
   <ins onclick="collapsedCat('category-<?php echo $juridicas[0]->getId()?>', this)" id="toggle-<?php echo $juridicas[0]->getId()?>" class="expanded">&nbsp;</ins>Jurídico-Social
    ...
    <li class="first_node">
      <ins onclick="collapsedCat('category-<?php echo $unedInstitucional->getId()?>', $('toggle-<?php echo $unedInstitucional->getId()?>'))">&nbsp;</ins>
      <ins onclick="collapsedCat('category-<?php echo $unedInstitucional->getId()?>', this)" id="toggle-<?php echo $unedInstitucional->getId()?>" class="expanded">&nbsp;</ins><?php echo $unedInstitucional->getName()?>
    </li>
   <ul id="category-<?php echo $unedInstitucional->getId()?>" style="width: 275px;">
    <?php foreach($unedInstitucional->getChildren() as $c): ?>
       <li class="second_node" draggable="true" data-id="<?php echo $c->getId() ?>">
         <a href="#" id="<?php echo $c->getId()?>" draggable="false" class="node <?php if($cat_id==$c->getId()) echo 'clicked'?>" style="text-decoration: none;" 
            data-id="<?php echo $c->getId() ?>"
            onclick="return treeUpdateMmList(this, <?php echo $c->getId()?>)">
   ...
   <span onclick="collapsedCat('category-<?php echo $cat_id?>', this)"></span>
    <li class="first_node">
      <ins onclick="collapsedCat('category-<?php echo $unedCultural->getId()?>', $('toggle-<?php echo $unedCultural->getId()?>'))">&nbsp;</ins>
      <ins onclick="collapsedCat('category-<?php echo $unedCultural->getId()?>', this)" id="toggle-<?php echo $unedCultural->getId()?>" class="expanded">&nbsp;</ins><?php echo $unedCultural->getName()?>
    </li>
    <ul id="category-<?php echo $unedCultural->getId()?>" style="width: 255px;">
    <?php foreach($unedCultural->getChildren() as $c): ?>
       <li class="second_node" draggable="true" data-id="<?php echo $c->getId() ?>">
         <a href="#" id="<?php echo $c->getId()?>" draggable="false" class="node <?php if($cat_id==$c->getId()) echo 'clicked'?>" style="text-decoration: none;" 
            data-id="<?php echo $c->getId() ?>"
            onclick="return treeUpdateMmList(this, <?php echo $c->getId()?>)">
