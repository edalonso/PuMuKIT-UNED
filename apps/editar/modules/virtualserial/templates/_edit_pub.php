...
<div id="remember_save_mm_pub" style="display: none; position: absolute; color:red; border: 1px solid red; padding: 5px; background-color:#fdc; font-weight:bold; right:20px">
...
procesaOk = function(){
  check_pass($('pass1'), $('pass2'), $('broadcast_id').value);//
  if(comprobar_form_pub( $("temporizada1_temporizada").checked, $("timestart1").value, $("timeend1").value,
                         ...
                         <?php echo get_js_regexp_timedate($sf_user->getCulture())?> ) && comprobar_form_pass() ) {
