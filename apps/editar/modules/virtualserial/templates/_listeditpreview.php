...
<div id="tv_admin_content_virtualserial" style="overflow: hidden; float: left; width: 78%">
  <!-- LIST -->
  <div id="list_mms" name="list_mms" act="/mms/list" style="min-width: 630px; margin-bottom: 3px; margin-right: 3px;">
    <?php include_component('virtualserial', 'list') ?>
  </div>
  <!-- EDIT -->
  <div id="edit_mms" class="tv_admin_edit" style="float:left; background: #8eb0bc url(/images/admin/cab/cab.gif) repeat-x scroll 0% 0%; margin-top: 3px; padding-top: 5px; min-width: 93%; overflow: hidden;">  
