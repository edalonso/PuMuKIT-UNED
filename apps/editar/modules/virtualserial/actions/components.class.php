...
class virtualserialComponents extends sfComponents
{
  ...
  public function executePreview()
  {
    ...
    $this->cat_raiz_uned = DataBaseProxy::getTematicasUned();
  ...
  public function executeTree()
  {
      ...
      $this->unedInstitucional = CategoryPeer::retrieveByCode("U990100");;//UNESCO propios de UNED
      $this->unedCultural = CategoryPeer::retrieveByCode("U990200");;//UNESCO propios de UNED


      //TODO MmPeer::... and CategoryPeer::...
      $this->num_all = MmPeer::doCount(new Criteria());

      //TODOUNED Query muy lenta
