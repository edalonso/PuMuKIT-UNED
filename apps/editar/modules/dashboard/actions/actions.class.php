...
class dashboardActions extends sfActions
{
  ...
  public function executeIndex()
  {
    ...
    $this->blocks = array('total', 'diskfree', 'transcoderinfo', 'lastmm', 'lastmmpublic', 'minibuscador');
  }
  ...
  {
    $this->setLayout(false);
    $this->serials = SerialPeer::doSelectWithI18n(new Criteria());
  ...
  {
    $this->setLayout(false);
    $this->mms = MmPeer::doSelectWithI18n(new Criteria());
    $this->getResponse()->setContentType("application/xml");
  }
}
