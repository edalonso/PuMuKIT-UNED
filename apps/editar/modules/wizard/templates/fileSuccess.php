...
<?php if ($module == 'virtualserial'):?>
  <form target="iframeUpload"  method="post" enctype="multipart/form-data" action="<?php echo url_for('wizard/endVirtual') . '?category_id=' . $sf_user->getAttribute('cat_id', null, 'tv_admin/virtualserial')?>">
<?php else:?>
  <form target="iframeUpload"  method="post" enctype="multipart/form-data" action="<?php echo url_for('wizard/end')?>">
<?php endif;?>
