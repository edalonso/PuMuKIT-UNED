...
<ul class="tv_admin_actions">
  ...
  <li><?php echo button_to_function('Next', "Modalbox.show('".url_for("wizard/mm"). '?mod=' . $module . "',{title:'PASO II: OBJ.MM.', params:Form.serialize('serial_form_wizard')})", 'class=tv_admin_action_next') ?> </li>
</ul>
