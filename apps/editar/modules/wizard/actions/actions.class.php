...
class wizardActions extends sfActions
{
  ...
  {
    if ($this->hasRequestParameter("mod") && $this->getRequestParameter("mod") == 'virtualserial'){
   ...
   *
   */
  public function executeEndVirtual()
  {
    set_time_limit(0);
