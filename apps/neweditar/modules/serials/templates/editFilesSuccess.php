...
<form id="form_udpate_files" method="post">
...
<div class="form-row">
  ...
  <div class="content" id="durationFile">
    <?php include_partial('durationFiles', array('min' => $file->getDurationMin(), 'seg' => $file->getDurationSeg() )) ?>
  </div>
</div>
...
<script type="text/javascript">
   $('#form_udpate_file').submit(function(e){
           e.preventDefault();
           $.ajax({
               type:"POST",
               url: '<?php echo url_for('serials/updateFiles') ?>',
               data: $(this).serialize(),
               success: function(e) {
