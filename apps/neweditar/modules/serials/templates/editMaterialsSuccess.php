...
<form method="post" enctype="multipart/form-data" target="iframeUpload" action="<?php echo url_for('serials/uploadMaterials')?>">
...
<?php if($material->isNew()):?>
  <li>
   <!-- TODO comprobar form_url y for_file_nmb-->
   <input type="submit" name="OK" value="OK" class="tv_admin_action_save">
  </li>
<?php else: ?>
  <li>
    <input type="submit" name="OK" value="OK" class="tv_admin_action_save MB_focusable">
  </li>
<?php endif ?>
</ul>
