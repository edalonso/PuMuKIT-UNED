...
<div class="form-row">
  ...
  <div class="content">
    <textarea id="embed_code" name="embed_code" readonly="readonly" cols="80" rows="5" onclick="this.select()">
       <iframe src="http://<?php echo sfConfig::get('app_info_link') . '/' . $sf_user->getCulture()?>/video/iframe/<?php echo $file->getMmId()?>.html" width="570" frameborder="0">
          Not understand iframes
       </iframe>
    </textarea>
  </div>
</div>
