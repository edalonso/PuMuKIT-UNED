...
<!-- PIC -->
<div id="serial_mm" class="serial_mm_<?php echo ($mm->getStatusId()?1:0)?>" style="background-color:transparent; margin: 0 auto; padding: 5% 0% 0% 12%;">
  <table>
   <tbody>
    <tr>
