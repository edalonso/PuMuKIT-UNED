...
<!--------------------->
  ...
  <table style="width:100%">
   <tbody>
   <tr> 
    <td style="background-color:transparent" height="53" valign="top" width="50%">
      <img src="<?php echo $serial->getFirstUrlPic()?>" style="border:3px solid #000000;" height="250" width="350" />
    </td>
