...
<div class="form-row">
  ...
  <div class="content content_long">
            <?php //$value = object_checkbox_tag($mm, 'getImportant', array ('control_name' => 'important','onchange' => "$('remember_save_mm').show()",)); echo $value ? $value : '&nbsp;' ?>
  </div>
</div>
...
<div class="form-row">
  <div style="float:left">
    ...
    <div class="content content_long">
            <?php //$value = object_select_tag($mm, 'getPlaceId', array ('related_class' => 'Place','control_name' => 'place_id',   'peer_method' => 'doSelectOrderWithPrecinctWithI18n','include_blank' => false,'size' => '1', 'onchange' => '$('#select_precinct').load('/neweditar.php/places/selectprecincts/id/' + $("place_id").value)')); echo $value ? $value : '&nbsp;' ?>
    </div>
  </div>
  ...
  <div style="float:left; margin-left: 100px">
    ...
    <div class="content content_long" id="select_precinct">
            <?php //echo select_tag('precinct_id',objects_for_select($mm->getPlace()->getPrecinctsWithI18n(), 'getId', 'getName' , $mm->getPrecinctId() ))?>
    </div>
  </div>
