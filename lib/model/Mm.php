...
{ 
  ...
  {
    throw new Exception('Mm::hasPubChannel not implemented');
   ...
   *
   */
  public function getSimilarMmsUned(){
  ...
  public function getUnedMediaOld()
  {
    $c = new Criteria();
    $c->add(UnedMediaOldPeer::MM_ID, $this->getId());

    return UnedMediaOldPeer::doSelectOne($c);
  }
