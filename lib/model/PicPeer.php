...
class PicPeer extends BasePicPeer
{
   ...
   * @return Resulset of Pic
   */
  public static function getPicsFromEvent($id)
  {
    $criteria = new Criteria();
    $criteria->addJoin(PicPeer::ID, PicEventPeer::PIC_ID);
    $criteria->add(PicEventPeer::OTHER_ID, $id);
    $criteria->addAscendingOrderByColumn(PicEventPeer::RANK);
