...
abstract class BaseEventI18n extends BaseObject  implements Persistent {
	...
	public function getEvent($con = null)
	{
		if ($this->aEvent === null && ($this->id !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = EventPeer::retrieveByPK($this->id, $con);
			   $obj->addEvents($this);
			 */
		}
		return $this->aEvent;
	...
	public function getEventWithI18n($con = null)
	{
		if ($this->aEvent === null && ($this->id !== null)) {
			...
			$this->aEvent = EventPeer::retrieveByPKWithI18n($this->id, $this->getCulture(), $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = EventPeer::retrieveByPKWithI18n($this->id, $this->getCulture(), $con);
			   $obj->addEvents($this);
			 */
		}
		return $this->aEvent;
