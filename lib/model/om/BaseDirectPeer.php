...
abstract class BaseDirectPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'ResolutionId', 'Url', 'DirectTypeId', 'ResolutionHor', 'ResolutionVer', 'Calidades', 'Debug', ),
		BasePeer::TYPE_COLNAME => array (DirectPeer::ID, DirectPeer::RESOLUTION_ID, DirectPeer::URL, DirectPeer::DIRECT_TYPE_ID, DirectPeer::RESOLUTION_HOR, DirectPeer::RESOLUTION_VER, DirectPeer::CALIDADES, DirectPeer::DEBUG, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'resolution_id', 'url', 'direct_type_id', 'resolution_hor', 'resolution_ver', 'calidades', 'debug', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'ResolutionId' => 1, 'Url' => 2, 'DirectTypeId' => 3, 'ResolutionHor' => 4, 'ResolutionVer' => 5, 'Calidades' => 6, 'Debug' => 7, ),
		BasePeer::TYPE_COLNAME => array (DirectPeer::ID => 0, DirectPeer::RESOLUTION_ID => 1, DirectPeer::URL => 2, DirectPeer::DIRECT_TYPE_ID => 3, DirectPeer::RESOLUTION_HOR => 4, DirectPeer::RESOLUTION_VER => 5, DirectPeer::CALIDADES => 6, DirectPeer::DEBUG => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'resolution_id' => 1, 'url' => 2, 'direct_type_id' => 3, 'resolution_hor' => 4, 'resolution_ver' => 5, 'calidades' => 6, 'debug' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
