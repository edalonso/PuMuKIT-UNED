...
abstract class BaseSessionPeer {
	...
	const DIRECT_ID = 'session.DIRECT_ID';

	/** the column name for the INIT_DATE field */
	const INIT_DATE = 'session.INIT_DATE';

	/** the column name for the END_DATE field */
	const END_DATE = 'session.END_DATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'EventId', 'DirectId', 'InitDate', 'EndDate', 'Notes', ),
		BasePeer::TYPE_COLNAME => array (SessionPeer::ID, SessionPeer::EVENT_ID, SessionPeer::DIRECT_ID, SessionPeer::INIT_DATE, SessionPeer::END_DATE, SessionPeer::NOTES, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'event_id', 'direct_id', 'init_date', 'end_date', 'notes', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'EventId' => 1, 'DirectId' => 2, 'InitDate' => 3, 'EndDate' => 4, 'Notes' => 5, ),
		BasePeer::TYPE_COLNAME => array (SessionPeer::ID => 0, SessionPeer::EVENT_ID => 1, SessionPeer::DIRECT_ID => 2, SessionPeer::INIT_DATE => 3, SessionPeer::END_DATE => 4, SessionPeer::NOTES => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'event_id' => 1, 'direct_id' => 2, 'init_date' => 3, 'end_date' => 4, 'notes' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'lib/model/map/SessionMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.SessionMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SessionPeer::EVENT_ID);

		$criteria->addSelectColumn(SessionPeer::DIRECT_ID);

		$criteria->addSelectColumn(SessionPeer::INIT_DATE);

		$criteria->addSelectColumn(SessionPeer::END_DATE);

		$criteria->addSelectColumn(SessionPeer::NOTES);

	}

	const COUNT = 'COUNT(session.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT session.ID)';
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
	...
	public static function doCountJoinEvent(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(SessionPeer::EVENT_ID, EventPeer::ID);
	...
	public static function doCountJoinDirect(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(SessionPeer::DIRECT_ID, DirectPeer::ID);
	...
	/**
	 * Selects a collection of Session objects pre-filled with their Event objects.
	 *
	...
	public static function doSelectJoinEvent(Criteria $c, $con = null)
	{
		...
		SessionPeer::addSelectColumns($c);
		$startcol = (SessionPeer::NUM_COLUMNS - SessionPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			$omClass = SessionPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addSession($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initSessions();
				$obj2->addSession($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	/**
	 * Selects a collection of Session objects pre-filled with their Direct objects.
	 *
	 * @return     array Array of Session objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinDirect(Criteria $c, $con = null)
	{
		...
		$c->addJoin(SessionPeer::DIRECT_ID, DirectPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		SessionPeer::addSelectColumns($c);
		$startcol2 = (SessionPeer::NUM_COLUMNS - SessionPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		EventPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + EventPeer::NUM_COLUMNS;

		DirectPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + DirectPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getDirect(); // CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addSession($obj1); // CHECKME
					break;
				}
			}
	...
	/**
	 * Selects a collection of Session objects pre-filled with all related objects except Event.
	 *
	 * @return     array Array of Session objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	/**
	 * Selects a collection of Session objects pre-filled with all related objects except Direct.
	 *
	 * @return     array Array of Session objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		$criteria->remove(SessionPeer::ID); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	require_once 'lib/model/map/SessionMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.SessionMapBuilder');
}
