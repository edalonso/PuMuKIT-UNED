...
(
	...
	`size` BIGINT default 0 NOT NULL,
	PRIMARY KEY (`id`),
	INDEX `material_event_FI_1` (`event_id`),
	CONSTRAINT `material_event_FK_1`
		FOREIGN KEY (`event_id`)
		REFERENCES `event` (`id`)
		ON DELETE CASCADE,
	INDEX `material_event_FI_2` (`mat_type_id`),
	CONSTRAINT `material_event_FK_2`
		FOREIGN KEY (`mat_type_id`)
		REFERENCES `mat_type` (`id`)
)Engine=MyISAM;
...
DROP TABLE IF EXISTS `material_event_i18n`;


CREATE TABLE `material_event_i18n`
(
	`name` VARCHAR(100)  NOT NULL,
	`id` INTEGER  NOT NULL,
	`culture` VARCHAR(7)  NOT NULL,
	PRIMARY KEY (`id`,`culture`),
	CONSTRAINT `material_event_i18n_FK_1`
		FOREIGN KEY (`id`)
		REFERENCES `material_event` (`id`)
		ON DELETE CASCADE
)Engine=MyISAM;
...
(
	...
	`url` VARCHAR(250),
	`secured` INTEGER default 0 NOT NULL,
...
DROP TABLE IF EXISTS `uned_media_old`;


CREATE TABLE `uned_media_old`
(
	`id` INTEGER  NOT NULL AUTO_INCREMENT,
	...
	`referencia_a_la_fuente` VARCHAR(255)  NOT NULL,
	`streaming` VARCHAR(255)  NOT NULL,
	`denegar_descarga` VARCHAR(255)  NOT NULL,
	...
	`preset_original` VARCHAR(255)  NOT NULL,
	`preset_alta` VARCHAR(255)  NOT NULL,
	`preset_media` VARCHAR(255)  NOT NULL,
	`preset_baja` VARCHAR(255)  NOT NULL,
	`tematicas` VARCHAR(255)  NOT NULL,
	`categorias` VARCHAR(255)  NOT NULL,
	`destinos_de_publicacion` VARCHAR(255)  NOT NULL,
	...
	PRIMARY KEY (`id`),
	INDEX `uned_media_old_FI_1` (`mm_id`),
	CONSTRAINT `uned_media_old_FK_1`
		FOREIGN KEY (`mm_id`)
		REFERENCES `mm` (`id`)
)Engine=MyISAM;
